...
# Read in data
dat = read.csv('./Scripts/Mplus CFA Inputs/proj-InitialPapers_asmt-A_time-1234_type-agg_shape-wide_clean_trimRTAccExOutlierRMBRTRegress_prog-Mplus_date-2023-09-09.csv', #sep = ' ', 
